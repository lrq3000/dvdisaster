 ...
 ***
 * Note thay endianess does not matter for the internal calculations,
...
#if 0
/***
 *** A simple little-endian CRC32 encoder.
 ***/

/* The standard ethernet poly in reversed bit order (unreversed = 0x04c11db7) */
