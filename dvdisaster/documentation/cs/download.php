...
<table width="100%">
  <tr>
    <td>dvdisaster je k dispozici pro <a href="download10.php">aktuální verze</a> operačních systémů FreeBSD, GNU/Linux, NetBSD a Windows. Je poskytován jako <a href="http://www.germany.fsfeurope.org/documents/freesoftware.en.html">volný software</a> pod <a href="http://www.gnu.org/licenses/gpl-3.0.txt">GNU General Public License v3</a>.</td>
...
?> <b>Stabilní verze</b> - doporučeno pro nové a nezkušené uživatele.<p><a name="download"></a>
...
<tr><td><b>dvdisaster-0.72</b></td><td align="right">2014-05-28</td></tr>
...
<?php
if($mode == "www")
    echo "<tr><td align=\"right\">Kontrolní součet MD5:&nbsp;</td><td>73699996b76aebf83b42ce0a35746616</td></tr>";
?>
...
?> 
   <tr><td colspan="2"><a href="download.php?showall=0#download">Skrýt starší verze z 0.72 větve</a></td></tr>
    ...
    <tr><td colspan="2"></td></tr>
    <tr><td></td><td>Verze 0.72.5</td></tr>
    <tr><td align="right">  Zdrojový kód (všechny operační systémy): </td>
    ...
    <tr><td align="right">Kontrolní součet MD5:&nbsp;</td><td>73699996b76aebf83b42ce0a35746616</td></tr>

    <tr><td colspan="2"></td></tr>
    <tr><td></td><td>Verze 0.72.4</td></tr>
    <tr><td align="right">  Zdrojový kód (všechny operační systémy): </td>
    ...
    <tr><td align="right">Kontrolní součet MD5:&nbsp;</td><td>ad5e1d3758c536472c0ec36e3fc521fe</td></tr>

    <tr><td colspan="2"></td></tr>
    <tr><td></td><td>Verze 0.72.3</td></tr>
    <tr><td align="right">  Zdrojový kód (všechny operační systémy): </td>
    ...
    <tr><td align="right">Kontrolní součet MD5:&nbsp;</td><td>4eb09c1aa3cdbc1dafdb075148fb471d</td></tr>
    ...
    <tr><td align=\"right\">Kontrolní součet MD5:&nbsp;</td><td>38389bbbeb0d259a3f0a8df89b363f72</td></tr>
    <tr><td colspan="2" class="esep"></td></tr>
    ...
    <tr><td align="right">Kontrolní součet MD5:&nbsp;</td><td>b6861ba1e8de6d91a2da5342a14870e0</td></tr>
...
<b>0.72 pl2</b> Tato verze přináší alternativní řešení chyby kvůli které v Linuxu docházelo k zamrzání paralelních SCSI adaptérů. Byla vylepšena kompatibilita s verzemi 0.79.x.<br> Verze pro Windows a Mac OS X jsou nyní sestavovány ve vývojovém prostředí pro dvdisaster 0.79.x a jsou tak dodávány s novějšími verzemi knihoven grafického sady nástrojů GTK+. Tato aktualizace si vyžádala určité změny v interních skriptech, takže došlo ke změně kontrolního součtu balíčku zdrojových kódů (balíček vydaný 31. října měl kontrolní součet md5 86110e212aa1bf336a52ba89d3daa93d a je stále platný pro Linux, FreeBSD a NetBSD).(2010-07-11)<p><b>0.72 pl1</b> Pablo Almeida vytvořil portugalský překlad programu. Přidána funkce která má předejít zamrzání Win XP u některých kombinací CD-RW/mechanik.(2009-08-08)<p><i>Aktualizace: tato funkce nefunguje vždy. Do <a href="download40.php">verze 0.79.x</a> byla přidána vylepšená verze, bohužel však nemůže být jednoduše použita ve stabilní verzi.</i> (06-Feb-2010)<p><b>0.72</b> První stabilní verze větve 0.72. Igor Gorbounov dokončil ruskou online dokumentaci. Byly opraveny některé chyby nalezené v první RC verzi.<p>Novější verze Windows nemusí při užití určitých jazykových nastavení použít správný jazyk zobrazení. Jde o složitější problém a bude proto vyřešen až v některé z verzí 0.73.x. (2009-07-04)<p><b>0.72-rc1</b> První RC. (2009-04-11)</td></tr></table>

<pre> </pre><b>Předešlá verze</b> - aktualizace na verzi 0.72 doporučena.<p><table class="download" cellpadding="0" cellspacing="5">
